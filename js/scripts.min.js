...
$(document).ready(function(){$("form").submit(function(){var th=$(this);$.ajax({type:"POST",url:"mail.php",data:th.serialize()}).done(function(){alert("Спасибо за заявку, в ближайшее время с Вами свяжется наш менеджер!");setTimeout(function(){th.trigger("reset");},1000);});return false;});});
// jquery.parallax.js
...
$(function(){$(window).scroll(function(){var i=$("#header").outerHeight(),o=$("#main").height(),s=$("#footer").outerHeight();$(this).scrollTop();$(this).scrollTop()>i?$("#top").fadeIn():$("#top").fadeOut(),$(this).scrollTop()>o?$("#top").css({bottom:s}):$("#top").css({bottom:"50px"})}),$(".product").click(function(){$(this).hasClass("active")?$(this).removeClass("active"):($(".product").removeClass("active"),$(this).addClass("active"))}),$(".decor").animated("zoomIn","zoomOut"),$(".navigation").mPageScroll2id(),$(".popup").magnificPopup({closeBtnInside:!0,fixedContentPos:!1,midClick:!0,type:"inline",mainClass:"white_popup"}),$(".parallax").parallax(),$(".slider").owlCarousel({loop:!0,margin:10,nav:!0,items:1,navText:["<img src='../img/nav_left.svg'>","<img src='../img/nav_right.svg'>"]}),$(".reviews_items").owlCarousel({loop:!0,margin:10,nav:!0,navText:["<img src='../img/nav_left.svg'>","<img src='../img/nav_right.svg'>"],responsiveClass:!0,responsive:{0:{items:1,nav:!1,dots:!0},768:{items:2,nav:!1,dots:!0},1000:{items:3,nav:!0,loop:!1}}})});